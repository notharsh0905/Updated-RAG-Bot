export const SUGGESTION_LABEL_MAP: Record<string, string> = {
...
export function getShortLabel(fullQuestion: string): string {
  return SUGGESTION_LABEL_MAP[fullQuestion] || `❓ ${fullQuestion.slice(0, 22)}...`;
}
