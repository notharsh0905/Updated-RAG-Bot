      ...
      if (data && data.length > 0) {
        ...
        const fallback: QueryTraceItem[] = [
          ...
          },
          {
            ...
            answer:
              'Yes, GATE qualified M.Tech students admitted through regular university counseling receive a monthly stipend of Rs. 12,400 per month via direct bank transfer.',
