...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full max-w-full shadow-sm">
      ...
      {/* Main University Navigation Bar - Horizontally Scrollable on Mobile */}
      <nav className="w-full bg-[#002B49] text-white flex items-center justify-between px-3 sm:px-8 text-xs font-semibold tracking-wide overflow-x-auto whitespace-nowrap scrollbar-none">
        ...
        <div className="hidden lg:flex items-center gap-2 py-1 px-3 rounded bg-white/10 border border-white/20 text-slate-100 text-[11px] font-medium shrink-0">
