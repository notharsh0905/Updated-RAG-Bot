  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-[#002B49] text-white shadow-lg space-y-4 relative overflow-hidden">
        <div className="absolute -right-8 -bottom-8 w-48 h-48 bg-[#1268D4]/10 rounded-full blur-2xl pointer-events-none" />
        
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/20 text-[#1E88FF] text-xs font-semibold">
              <Award className="w-4 h-4 text-[#1268D4]" />
          ...
          <div className="p-5 rounded-2xl bg-black/30 border border-white/15 text-center shrink-0 backdrop-blur-md min-w-[160px]">
            ...
            <div className="text-3xl sm:text-4xl font-extrabold text-[#1268D4] font-mono mt-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs space-y-2">
          <div className="flex items-center justify-between text-xs text-slate-500 font-semibold">
            ...
            <ShieldAlert className="w-4 h-4 text-[#1268D4]" />
          </div>
          <div className="text-2xl font-extrabold text-amber-600 dark:text-[#1E88FF]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div
          ...
          className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-[#002B49] dark:hover:border-[#1E88FF] transition-all shadow-xs cursor-pointer group space-y-3"
        >
          <div className="flex items-center justify-between">
            <span className="p-2.5 rounded-xl bg-blue-50/50 dark:bg-blue-950/60 border border-slate-200 dark:border-blue-950 text-amber-600 dark:text-[#1E88FF]">
              <Clock className="w-5 h-5" />
            </span>
            <ChevronRight className="w-4 h-4 text-slate-400 group-hover:text-[#002B49] dark:group-hover:text-[#1268D4] group-hover:translate-x-1 transition-all" />
          </div>
          <div>
